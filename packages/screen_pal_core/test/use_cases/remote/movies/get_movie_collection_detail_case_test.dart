...
void main() {
  ...
  test(
    'GetMovieCollectionDetailCase - should orchestrating get movie collection detail action correctly',
    () async {
      when(mockMoviesRepo.getMovieCollectionDetail(123))
          .thenAnswer((_) async => dummyMovieCollectionDetail);

      final movieCollectionDetail = await subject.execute(123);

      expect(movieCollectionDetail, dummyMovieCollectionDetail);
